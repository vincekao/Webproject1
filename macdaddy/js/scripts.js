...
function start() {
    ...
    var canvas = document.getElementById("canvas"),
        ...
        shootingStars = [],
        layers = [
            { speed: 0.515, scale: 0.2, count: 320 },
            { speed: 0.53, scale: 0.5, count: 50 },
            { speed: 0.55, scale: 0.75, count: 30 }
        ],
        starsAngle = 40,
        shootingStarSpeed = {
            min: 15,
        ...
        trailLengthDelta = 0.09,
        shootingStarEmittingInterval = 2000,
        shootingStarLifeTime = 200,
        maxTrailLength = 300,
        starBaseRadius = 2,
    ...
    function drawStar(star) {
        context.fillStyle = "rgb(19, 19, 57)";
        context.beginPath();
    ...
    function drawShootingStar(p) {
        ...
        //trail
        context.fillStyle = "rgba(19, 19, 57, " + p.opacity + ")";
        context.beginPath();
        context.moveTo(x - 1, y - 1);
